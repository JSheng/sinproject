 ...
 */
export const getUnion = (arr1: Array<Number|String>, arr2: Array<Number|String>) => {
 ...
 */
export const hasOneOf = (targetarr: Array<Number|String>, arr: Array<Number|String>) => {
 ...
 */
export function oneOf (value: String|Number, validList: any[]) {
 ...
 */
const getDate = (timeStamp: number, startType: string | undefined) => {
